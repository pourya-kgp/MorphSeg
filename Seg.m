%                             Automatic Feature Extraction on page of Antique Books
%
clear all 
close all
clc
input = imread('D:\Bachelor & Master Science\M.S. Azad Tehran Markazi\Courses\Image Processing\Project\Antique Books\Pierre Belons Book Images\Pierre Belon_Page_005.jpg');
...
% Negative image
i3 = ~i2;
% Enhance the image to get rid of small connected component
i4 = bwareaopen(i3,35);
clear i1 i2 i3 se1
